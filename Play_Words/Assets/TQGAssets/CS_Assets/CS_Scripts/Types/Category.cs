...
namespace TriviaQuizGame.Types
{
	...
	{
		// Used to hold the state of the category, if it was completed or not. 0 = not completed, 1 = victory.
		// Later I might add other states, maybe to show a star rating.
		...
		[Tooltip("A list of questions in the category. Each question has a number of correct/wrong answers, " +
			"a followup text, a bonus value, time, and can also have an image/video as the background of the question")]
